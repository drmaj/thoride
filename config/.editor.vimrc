...
if (g:editor_use_bkp_files == 1 || g:editor_use_swp_files == 1 || g:editor_use_undo_files == 1)
    if !isdirectory(g:THORIDE_ROOT_DIRECTORY . '/.tmp')
        call mkdir(g:THORIDE_ROOT_DIRECTORY . '/.tmp', 'p')
    endif
endif

set nobackup
if (g:editor_use_bkp_files == 1)
    set backupdir=g:THORIDE_ROOT_DIRECTORY . '.tmp/.backup//'
    if !isdirectory(g:THORIDE_ROOT_DIRECTORY . '/.tmp/.backup')
        call mkdir(g:THORIDE_ROOT_DIRECTORY . '/.tmp/.backup', 'p')
    endif
endif

set noswapfile
if (g:editor_use_swp_files == 1)
    set directory=g:THORIDE_ROOT_DIRECTORY . '.tmp/.swp//'
    if !isdirectory(g:THORIDE_ROOT_DIRECTORY . '/.tmp/.swp')
        call mkdir(g:THORIDE_ROOT_DIRECTORY . '/.tmp/.swp', 'p')
    endif
endif

set nowritebackup
if (g:editor_use_undo_files == 1)
    set undodir=g:THORIDE_ROOT_DIRECTORY . '.tmp/.undo//'
    if !isdirectory(g:THORIDE_ROOT_DIRECTORY . '/.tmp/.undo')
        call mkdir(g:THORIDE_ROOT_DIRECTORY . '/.tmp/.undo', 'p')
    endif
endif
